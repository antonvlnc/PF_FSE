#Programa HX711 (Báscula)
#source repo: https://github.com/tatobari/hx711py/blob/master/example.py
...
while True:
    try:
        ...
        #prueba
        val = max(0, round(hx.get_weight(5), 1))  # Redondea a 1 decimal
        print(f"{val} g")
